...
public final class CommonmarkDocumentMarkdomDispatcher implements MarkdomDispatcher {
	...
	public CommonmarkDocumentMarkdomDispatcher(Document document) throws IllegalArgumentException {
	...
	public <Result> Result handle(MarkdomHandler<Result> handler) {
		...
		visitDocument(new SimpleMarkdomHandler<Result>(handler));
		return handler.getResult();
	}

	private void visitDocument(final SimpleMarkdomHandler<?> handler) {
		document.accept(new AbstractVisitor() {
			...
			private String visitText(Node parent) {
				StringBuilder builder = new StringBuilder();
				parent.accept(new CommonmarkTextVisitor(builder));
