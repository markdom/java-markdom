...
public final class BlacklistTypebasedMarkdomFilterDelegate implements TypebasedMarkdomFilterDelegate {

	private final Set<MarkdomBlockType> blockTypes;

	private final Set<MarkdomContentType> contentTypes;

	public BlacklistTypebasedMarkdomFilterDelegate(Set<MarkdomBlockType> blockTypes, Set<MarkdomContentType> contentTypes) {
